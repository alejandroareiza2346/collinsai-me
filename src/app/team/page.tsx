        ...
        <section className="mt-8 pb-6">
          <GlassCard className="overflow-hidden p-6 sm:p-8 lg:p-10">
            <div className="grid gap-10">
              <div>
                <p className="text-xs uppercase tracking-[0.28em] text-white/45">Team</p>
                <h3 className="mt-3 text-3xl font-semibold tracking-tight text-white/92 sm:text-4xl">Founder-led delivery</h3>
                <p className="mt-4 max-w-xl text-sm leading-6 text-white/65 sm:text-base">Based in Medellín, Colombia, CollinsAI is a founder-led team combining strategy, implementation, and delivery for SMB automation projects. We prioritize secure, measurable operational outcomes and hands-on delivery during Phase 1 (agency).</p>
              </div>
            </div>
          </GlassCard>
        </section>
