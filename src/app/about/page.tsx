          ...
          <GlassCard className="overflow-hidden p-6 sm:p-8 lg:p-10">
            <div className="grid gap-10">
              <div>
                ...
                <h3 className="mt-3 text-3xl font-semibold tracking-tight text-white/92 sm:text-4xl">Who we are</h3>
                <p className="mt-4 max-w-xl text-sm leading-6 text-white/65 sm:text-base">CollinsAI is an Automation Intelligence company based in Medellín, focused on helping SMBs modernize operations with AI, automation, dashboards, and integrations.</p>
              </div>
            </div>
          </GlassCard>
        </section>
