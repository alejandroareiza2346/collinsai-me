          ...
          <GlassCard className="overflow-hidden p-6 sm:p-8 lg:p-10">
            <div className="grid gap-10">
              <div>
                ...
                <p className="text-xs uppercase tracking-[0.28em] text-white/45">Engagement model</p>
                <h3 className="mt-3 text-3xl font-semibold tracking-tight text-white/92 sm:text-4xl">Project-based delivery with private proposals</h3>
                <p className="mt-4 max-w-xl text-sm leading-6 text-white/65 sm:text-base">CollinsAI scopes each engagement around the problem, the integrations involved, and the delivery timeline. Typical flow: operational diagnostic → Automation MVP (2–6 weeks) → iterate and monitor. Most work is quoted privately after discovery.</p>
              </div>
            </div>
          </GlassCard>
        </section>
